#' Données des élus conseillers municipaux en France
#'
...
#'   \item{Code.de.la.collectivité.à.statut.particulier}{Code de la collectivité avec un statut particulier.}
#'   \item{Libellé.de.la.collectivité.à.statut.particulier}{Nom de la collectivité avec un statut particulier.}
#'   \item{Code.de.la.commune}{Code INSEE de la commune.}
#'   \item{Libellé.de.la.commune}{Nom de la commune.}
#'   \item{Nom.de.l.élu}{Nom de l'élu municipal.}
#'   \item{Prénom.de.l.élu}{Prénom de l'élu municipal.}
#'   \item{Code.sexe}{Code du sexe de l'élu (M/F).}
#'   \item{Date.de.naissance}{Date de naissance de l'élu.}
#'   \item{Code.de.la.catégorie.socio.professionnelle}{Code de la catégorie socio-professionnelle.}
...
#'   \item{Date.de.début.de.la.fonction}{Date de début de la fonction.}
